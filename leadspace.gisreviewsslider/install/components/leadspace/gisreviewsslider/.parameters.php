...
$arComponentParameters = array(
    ...
    "PARAMETERS" => array(
        ...
        "AUTOPLAY" => array(
            "PARENT" => "BASE",
            "NAME" => GetMessage("LEADSPACE_AUTO_SCROLL"),
            "TYPE" => "LIST",
            "VALUES" => [
                "N" => GetMessage("LEADSPACE_AUTO_SCROLL_N"),
                "Y" => GetMessage("LEADSPACE_AUTO_SCROLL_Y"),
            ],
        ),
        "AUTOPLAY_SPEED" => array(
            "PARENT" => "BASE",
            "NAME" => GetMessage("LEADSPACE_AUTO_SCROLL_SPEED"),
            "TYPE" => "STRING",
            "DEFAULT" => 2000,
        ),
        "COLOR_BUTTONS" => array(
